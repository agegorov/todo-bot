...
func main() {
	...
	required := []string{"TELEGRAM_TOKEN", "DATABASE_URL", "WHISPER_ENDPOINT", "GOOGLE_CLIENT_ID", "GOOGLE_CLIENT_SECRET", "BASE_URL"}
	...
	b, err := bot.New(os.Getenv("TELEGRAM_TOKEN"), queries, w)
	if err != nil {
